...
EMAIL_HOST_USER = '1396902579@qq.com'
EMAIL_HOST_PASSWORD = 'ztyrgryaoxkqiceh'  # 这个不是邮箱密码，而是授权码
EMAIL_PORT = 587 # 由于阿里云的25端口打不开，所以必须使用SSL然后改用465端口
# 是否使用了SSL 或者TLS，为了用465端口，要使用这个
EMAIL_USE_SSL = True
# 默认发件人，不设置的话django默认使用的webmaster@localhost，所以要设置成自己可用的邮箱
DEFAULT_FROM_EMAIL = '风晓 <1396902579@qq.com>'

# 网站默认设置和上下文信息
SITE_END_TITLE = '风晓'
SITE_DESCRIPTION = '风晓,个人博客,python,后端,java'
SITE_KEYWORDS = '风晓,个人博客,python,java'
